      ...
      <PetsList>
        {pets.map((pet) => (
          <PetsListItem key={pet._id}>
            <PetsContainer>
              {pet.species_id === "620e79f32f4ae96d579ee875" && (
                <Edgar color={pet.color} />
              )}
              {pet.species_id === "620e79f32f4ae96d579ee873" && (
                <Squiggle color={pet.color} />
              )}
              {pet.species_id === "620e79f32f4ae96d579ee874" && (
                <Radclyf color={pet.color} />
              )}
              {pet.species_id === "620e79f32f4ae96d579ee876" && (
                <Dustsprite color={pet.color} />
              )}
            </PetsContainer>
            <DisplayPets>{pet.name}</DisplayPets>
          </PetsListItem>
        ))}
      </PetsList>
    </>
