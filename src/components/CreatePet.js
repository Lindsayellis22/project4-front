...
function CreatePet(props) {
  ...
  return (
    <div>
      ...
      <SpeciesCard>
        <SpeciesContainer>
          {species._id === "620e79f32f4ae96d579ee873" && (
            <Squiggle color={color} />
          )}
          {species._id === "620e79f32f4ae96d579ee874" && (
            <Radclyf color={color} />
          )}
          {species._id === "620e79f32f4ae96d579ee875" && (
            <Edgar color={color} />
          )}
          {species._id === "620e79f32f4ae96d579ee876" && (
            <Dustsprite color={color} />
          )}
        </SpeciesContainer>
      </SpeciesCard>
